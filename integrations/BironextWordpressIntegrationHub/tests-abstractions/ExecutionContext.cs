...
namespace tests.composition.common
{
    public class ExecutionContext
    {
        ...
        private BirowooTestWorkloadObj _workloadObject;
        private string _integName;

        public ExecutionContext(IMyLogger logger, BirowooTestWorkloadObj workloadObject, string integName)
        {
            _logger = logger;
            _workloadObject = workloadObject;
            _integName = integName;
        }
        ...
        public BirowooTestWorkloadObj WorkloadObject
        {
            get { return _workloadObject; }
            set { _workloadObject = value; }
        }

        public string IntegName
        {
            get { return _integName; }
            set { _integName = value; }
        }
    }
}
