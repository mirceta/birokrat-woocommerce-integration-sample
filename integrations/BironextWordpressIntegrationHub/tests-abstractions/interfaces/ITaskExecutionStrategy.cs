...
{
    public interface ITaskExecutionStrategy : IObservable<string>
    {
        Task<AllFinishedObservable> Run();

        Task Update(IUpdateCommand command);

        Task<AllFinishedObservable> GetAllFinishedObservable();
