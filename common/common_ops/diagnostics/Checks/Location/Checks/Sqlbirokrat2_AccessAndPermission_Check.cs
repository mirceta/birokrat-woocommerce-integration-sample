...
namespace common_ops.diagnostics.Checks.Location.Checks
{
    ...
    /// </summary>
    ///
    public class Sqlbirokrat2_AccessAndPermission_Check : ICheck
    {
        private readonly ILocationHelper _locationHelper;

        /// <summary>
        /// <inheritdoc cref="Sqlbirokrat2_AccessAndPermission_Check"/>
        /// </summary>
        public Sqlbirokrat2_AccessAndPermission_Check(ILocationHelper locationHelper)
        {
        ...
        {
            var result = _locationHelper.IsReadPermissionGranted(BiroLocationConstants.DefaultDLLOrigin);

            var info = BiroLocationConstants.DefaultDLLOrigin + TextConstants.DELIMITER + result;
