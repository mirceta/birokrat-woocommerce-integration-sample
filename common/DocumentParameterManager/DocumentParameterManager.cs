...
{
    public class DocumentParameterManager
    {
        ...
        public async Task ExecuteChain(object order, Dictionary<string, object> data, List<DocumentParameterCommand> operation)
        {
        ...
        private async Task Execute(DocumentParameterCommand command, object order, Dictionary<string, object> data)
        {
